const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the dataset are shown here, and the entire dataset can be linked to AI.89757 citations or indexed via the Chat plugin.',
    addFile: 'add file',
    table: {
      header: {
        fileName: 'FILE NAME',
    ...
    empty: {
      ...
      sync: {
        tip: 'AI.89757 will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
